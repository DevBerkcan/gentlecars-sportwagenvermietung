export default function TrustBadges() {
  const badges = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 0l3.708 7.514 8.292 1.205-6 5.85 1.416 8.256L12 18.9l-7.416 3.925L6 14.57 0 8.719l8.292-1.205L12 0z" fill="#00B67A"/>
        </svg>
      ),
      link: '#'
    },
    {
      name: 'Geprüfte Sicherheit',
      badge: 'TÜV zertifiziert',
      icon: (
            ...
            >
              ...
              {badge.link && (
                <a
                  ...
                  aria-label={`Besuchen Sie unsere ${badge.name} Seite`}
                />
              )}
            </div>
          ))}
