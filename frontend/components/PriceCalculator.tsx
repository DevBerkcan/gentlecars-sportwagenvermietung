      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="flex-1 h-2 bg-white/10 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-emerald-400"
                  />
                  <div className="text-white font-bold text-2xl min-w-[80px] text-right">
            ...
            <div className="bg-gray-900/50 border border-white/10 rounded-xl p-6">
              ...
              <div className="space-y-2">
                {extras.map((extra) => (
                  <label
                    key={extra.id}
                    className="flex items-center justify-between p-3 rounded-lg border border-white/10 hover:border-emerald-400/30 transition-all cursor-pointer"
                  >
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-emerald-900/20 to-black border border-emerald-400/20 rounded-xl p-6 sticky top-24">
              <h3 className="text-white font-serif text-2xl mb-6">Zusammenfassung</h3>
              ...
              <div className="border-t border-emerald-400/30 pt-4 mb-6">
                <div className="flex justify-between items-baseline">
                  <span className="text-white font-semibold text-lg">Gesamtpreis</span>
              ...
              <button className="w-full px-6 py-4 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-lg transition-all uppercase tracking-wider">
                Jetzt anfragen
              </button>
